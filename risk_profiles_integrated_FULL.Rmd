...
psi.mat[1,] <- c(rep(-0.25,times=3))
psi.mat[2,] <- c(rep(0,times=3))
...
# freq.LAC.obs.age[,2] <- c(0.079, 0.794, 0.120)  # Jul15
...
## Create a third column representing t3 (same values as t2)
table1[3,] <- table1[2,]
table1[4,] <- table1[2,]
...
risk_table_CFR <- filter(risk_table_CFR, "Pop.Prev" > 0.0000001)  # FILTER PROFILES TO SHOW IN THE TABLE TO ONLY THOSE > 0 PREVALENCE
